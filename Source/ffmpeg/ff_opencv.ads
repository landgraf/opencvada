...
package Ff_Opencv is
   function Cv_Create_File_Capture_Ffmpeg (Filename : String)
                                        return Cv_Capture_Ptr;

   procedure Cv_Release_Capture_Ffmpeg (Capture : access Cv_Capture_Ptr);

   function Cv_Set_Capture_Property_Ffmpeg (Capture : Cv_Capture_Ptr;
                                         Prop_Id : Highgui.Capture_Property;
                                         Value   : Long_Float)
                                         return Integer;

   function Cv_Get_Capture_Property_Ffmpeg (Capture : Cv_Capture_Ptr;
                                         Prop_Id : Highgui.Capture_Property)
                                         return Long_Float;

   function Cv_Grab_Frame_Ffmpeg (Capture : Cv_Capture_Ptr)
                                return Integer;

   function Cv_Retrieve_Frame_Ffmpeg (Capture : Cv_Capture_Ptr;
                                    Stream_Idx : Integer)
   ...
   procedure Cv_Release_Video_Writer_Ffmpeg (Writer : access Cv_Video_Writer_Ptr);

   function Cv_Write_Frame_Ffmpeg (Writer : Cv_Video_Writer_Ptr;
                                 Image  : Ipl_Image_Ptr)
                                 return Integer;
private
