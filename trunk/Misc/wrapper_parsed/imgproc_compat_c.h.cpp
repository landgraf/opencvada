...
void cvConvexHull (CvPoint * points , int num_points , CvRect * CV_UNREFERENCED bound_rect , int orientation , int * hull , int * hullsize ){
	cvConvexHull(/*CvPoint*//***/points , /*int*/num_points , /*CvRect*//***//*CV_UNREFERENCED*/bound_rect , /*int*/orientation , /*int*//***/hull , /*int*//***/hullsize);
}
void cvMinAreaRect (CvPoint * points , int n , int CV_UNREFERENCED left , int CV_UNREFERENCED bottom , int CV_UNREFERENCED right , int CV_UNREFERENCED top , CvPoint2D32f * anchor , CvPoint2D32f * vect1 , CvPoint2D32f * vect2 ){
...
void cvUnDistortOnce (const CvArr * src , CvArr * dst , const float * intrinsic_matrix , const float * distortion_coeffs , int CV_UNREFERENCED interpolate ){
...
void cvUnDistortInit (const CvArr * CV_UNREFERENCED src , CvArr * undistortion_map , const float * A , const float * k , int CV_UNREFERENCED interpolate ){
...
void cvUnDistort (const CvArr * src , CvArr * dst , const CvArr * undistortion_map , int CV_UNREFERENCED interpolate ){
